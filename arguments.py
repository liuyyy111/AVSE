...
def get_argument_parser():
    ...
    parser.add_argument("--token_compress", action='store_true', help='whether use token compress')
    ...
    parser.add_argument('--hugging_face', action='store_false', help='use huggingface implement for vision transformer')
    # optimizer
